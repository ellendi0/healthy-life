...
public class DietMapper {
    public Diet map(Diet dietToUpdate, double bmr){
        ...
        dietToUpdate.setNumberOfProtein(DoubleRounder
                .round(dietToUpdate.getNumberOfDailyCalories() * 0.25/4, 3));
        dietToUpdate.setNumberOfFat(DoubleRounder
                .round(dietToUpdate.getNumberOfDailyCalories() * 0.3/9, 3));
        dietToUpdate.setNumberOfCarbohydrate(DoubleRounder
                .round(dietToUpdate.getNumberOfDailyCalories() * 0.45/4, 3));
        dietToUpdate.setNumberOfSugar(DoubleRounder
                .round(dietToUpdate.getNumberOfDailyCalories() * 0.1/4, 3));
        dietToUpdate.setNumberOfFiber(DoubleRounder
                .round(dietToUpdate.getNumberOfDailyCalories() / 1000 * 14, 3));
        return dietToUpdate;
    }
